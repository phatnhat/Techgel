...
public class NewsList extends BasedEntity {
    ...
    public NewsList(Long id, String title_vi, String title_en, NewsType type, String summary_vi, String summary_en, String content_vi, String content_en, String image_url) {
        super(id);
    ...
    public String getSummary(String lang){
        return "vi".equalsIgnoreCase(lang) ? summary_vi : summary_en;
    }
