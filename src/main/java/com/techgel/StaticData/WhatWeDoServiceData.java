...
public abstract class WhatWeDoServiceData {
    public static List<WhatWeDoService> get() {
        ...
        WhatWeDoService item2 = new WhatWeDoService(2L, "Công trình nhà ga", "Aviation", 2,
                "/imgs/field-of-activities/aviation.webp", "/imgs/field-of-activities/aviation-popup.png",
        ...
        WhatWeDoService item3 = new WhatWeDoService(3L, "Công nghiệp", "Industry", 3,
                "/imgs/field-of-activities/industry.jfif", "/imgs/field-of-activities/industry-popup.png",
        ...
        WhatWeDoService item6 = new WhatWeDoService(6L, "Công nghệ", "Technology", 6,
                "/imgs/field-of-activities/technology.jpg", "/imgs/field-of-activities/technology-popup.png",
        ...
        item3.setWhatWeDoServiceItems(List.of(
                ...
                new WhatWeDoServiceItems(11L, "Nhà xưởng khu công nghiệp", "", 11,
                        "Chúng tôi thiết kế và xây dựng các nhà xưởng, khu công nghiệp đạt tiêu chuẩn, đáp ứng nhu cầu sản xuất của doanh nghiệp. Các công trình được trang bị hệ thống điện, thông gió, PCCC hiện đại, cùng hạ tầng giao thông và logistics đồng bộ, tạo môi trường làm việc an toàn và hiệu quả.\n" +
                                "\n" +
