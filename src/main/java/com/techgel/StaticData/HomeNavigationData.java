...
public abstract class HomeNavigationData {
    public static List<HomeNavigation> get(){
        ...
        HomeNavigation aboutUs6 = new HomeNavigation("Quan hệ cổ đông", "5", true, 6, aboutUs, "/about-us/shareholder", "/imgs/banners/shareholders.jpg");
        ...
        HomeNavigation news1 = new HomeNavigation("Tin dự án", "", true, 1, news, "/news?type=PROJECT", "");
        HomeNavigation news2 = new HomeNavigation("Hoạt động nội bộ", "", true, 2, news, "/news?type=INTERNAL", "");
        HomeNavigation news3 = new HomeNavigation("Huấn luyện đào tạo", "", true, 3, news, "/news?type=TRAINING", "");
        news.setChildren(Set.of(news1, news2, news3));
